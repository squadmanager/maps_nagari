...
DailyTaskRsModel dailyTaskRsModelFromJson(String str) =>
    DailyTaskRsModel.fromJson(json.decode(str));

String dailyTaskRsModelToJson(DailyTaskRsModel data) =>
    json.encode(data.toJson());

class DailyTaskRsModel {
  bool status;
  String message;
  List<DataDailyTaskRsModel> data;
  ...
  factory DailyTaskRsModel.fromJson(Map<String, dynamic> json) =>
      DailyTaskRsModel(
        status: json["status"],
        message: json["message"],
        data: List<DataDailyTaskRsModel>.from(
            json["data"].map((x) => DataDailyTaskRsModel.fromJson(x))),
      );
...
class DataDailyTaskRsModel {
  ...
  factory DataDailyTaskRsModel.fromJson(Map<String, dynamic> json) =>
      DataDailyTaskRsModel(
